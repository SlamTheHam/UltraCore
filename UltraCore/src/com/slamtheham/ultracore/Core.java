	...
	public boolean onCommand(CommandSender sender, Command cmd, String string, String[] strings) {
		if (string.equalsIgnoreCase("core")) {
			...
			if (strings.length == 0) {
				...
				message.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
				...
				message1.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
				...
				message2.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
				...
				message3.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
				...
				message4.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
				...
				message5.setHoverEvent( new HoverEvent( HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("Click to autofull text console").create() ) );
