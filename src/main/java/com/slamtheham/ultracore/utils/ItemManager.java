...
public class ItemManager {
    ...
    public static ItemStack addLore(ItemStack item, String... lore) {
        ...
        lorez.addAll(Arrays.asList(lore));
        meta.setLore(lorez);
        item.setItemMeta(meta);
        return item;
    }
    ...
    public static String getStringFromItemLore(ItemStack e, String s) {
        ...
        for (int i = 0; i < e.getItemMeta().getLore().size(); i++) {
            if (((String) e.getItemMeta().getLore().get(i)).contains(s)) {
                return cleanLoreLine((String) e.getItemMeta().getLore().get(i));
            }
        }
        return result;
    }

    private static String cleanLoreLine(String s) {
        String[] args = s.split(":");
    ...
    public static class ItemCreator {
        ...
        public ItemCreator setLore(Integer index, String l) {
    ...
    protected static class EnchantGlow
